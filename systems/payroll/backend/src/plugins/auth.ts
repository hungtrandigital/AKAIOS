// JWT verification + RBAC plugin (same as attendance-api).
// Uses fastify-plugin for proper encapsulation.
...
// (RBAC Option B — role -> permission mapping editable via /v1/rbac API)
