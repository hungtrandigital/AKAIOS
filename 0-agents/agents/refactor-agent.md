...
- `0-agents/mode/[mode].md` (updated paths where needed)
- `0-agents/workflows/[workflow].md` (updated paths where needed)

**Structure Decisions**:
- [List confirmed structure decisions]

**Next recommended agent**: [@fullstack-engineer / @docs-guardian / Human]  
